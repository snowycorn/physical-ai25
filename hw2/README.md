...
```bash
install pandas openpyxl matplotlib opencv-python
```

## Run the Program

### 1. Modify input paths in `src/main.py` if needed:
...
The output map.png and navigation video can be find in `/results` by defaults
